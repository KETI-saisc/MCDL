    ...
    for l in range(n_loops):
        ...
        if augment_seq:
            ...
            for s_idx in range(len(seq_inputs)):
                ...
                # seq_inputs[s_idx] = seq_inputs[s_idx][n_skips:] ######################################################################## original
                seq_inputs[s_idx] = seq_inputs[s_idx][:]##################################################################################for broadcasting problem
                # seq_targets[s_idx] = seq_targets[s_idx][n_skips:]####################################################################### original
                seq_targets[s_idx] = seq_targets[s_idx][:]####################################################################################for broadcasting problem
